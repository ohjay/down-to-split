...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { cost: @debt.cost, creditor_id: @debt.creditor_id, debtor_id: @debt.debtor_id }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { cost: @debt.cost, creditor_id: @debt.creditor_id, debtor_id: @debt.debtor_id }
    assert_redirected_to debt_path(assigns(:debt))
  end
